<!-- Sidebar -->
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush" id="navigations">
        ...
        <a href="index.php?page=view_users&title=view_users" class="list-group-item list-group-item-action nav-home waves-effect">
          <i class="fas fa-chart-pie mr-3"></i>View all Users
        </a>
