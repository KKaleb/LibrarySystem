    ...
    <div class="row">
        <div class="col-md-4 offset-md-4">
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Search with isbn, Book Name & Author" id="filter">
            </div>
        </div>
        <div class="col-sm-4">
            <button class="float-right btn btn-primary btn-sm" id='new_book'><i class="fa fa-plus"></i> Create New Book</button>
        </div>
    </div>
</div>
<?php 
...
<div class="col-md-12 books-field" id="">
    <div class="card card-cascade wider ml-1 mr-1 float-left" style="width:20%">
        ...
        <p class="card-text text-truncate">ISBN: <?php echo $row['isbn'] ?></p>
...
$(document).ready(function(){
    $('#filter').on('keyup', function(){
        ...
        _field.each(function(){
            ...
            var isbn = $(this).find('.card-text').text()
