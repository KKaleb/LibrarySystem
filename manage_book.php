...
<div class="container-fluid">
    <form action="" id="manage_book">
        ...
        <div class="">
            <label for="location">Book ISBN</label>
            <input type="text" id="isbn" name="isbn" class="form-control" value="<?php echo isset($meta['isbn']) ? $meta['isbn'] : "" ?>" required>
        </div>
        <div class='mt-3'>
        ...
        <!-- <div class=" mt-3">
            <div class="input-group">
                ...
                <div class="custom-file">
                    ...
                    aria-describedby="img-label"  accept="image/png,image/gif,image/jpg" onchange="displayIMG(this)">
