<div class="col-md-12">
    <div class="row">
        <div class="col-sm-12">
            <button class="float-right btn btn-primary btn-sm" id='new_borrow'><i class="fa fa-plus"></i> New Borrower</button>
        </div>
    </div>
</div>
<?php 
            ...
            while($row= $borrowed->fetch_assoc()){   
                ...
                <tr>
                    ...
                    <b>Title: </b><?php echo $row['title']; ?><br>
                     ...
                     <b>Return Status: </b><?php echo $row['status'] > 0 ? '<div class="badge badge-success">Returned</div>' : '<div class="badge badge-warning">Pending</div>' ;
